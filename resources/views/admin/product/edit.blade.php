            ...
            <td>
                <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_produk" placeholder="Nama Produk" class="form-control" value="{{$product->nama_produk}}">
                        
                    </div>
                    <div>
                        <label for="qty">Harga</label>
                        <input type="number" name="harga" placeholder="Harga" class="form-control" value="{{$product->harga}}">
                    </div>
                    <div>
